...
async def addfilter(client, message):
    ...
    if len(args) < 2:
        await message.reply_text("Commande Incomplet :(", quote=True)
        return
...
async def deletefilter(client, message):
    ...
    try:
        ...
        await message.reply_text(
            "<i>pour supprimer un filtre!</i>\n\n"
            "<code>/del le nom du filtre</code>\n\n"
            "Utilise /viewfilters pour voir tous les filtres disponibles",
            quote=True
        )
        return
